function dydt = ASFModelEstoniaNOSURV(t, y, feeding, bF, bE, dw)
dydt = zeros(7,1);

%%% ASF model for the scenario in Estonia but with no survivor class of
%%% individuals. Here, we represent this by setting rho = 1.
...
rho = 1;        %rho = 1 represents no survivor class
...
%Transmission Coefficients: D - direct contact, E - environmental, V -
%vector to host, W - host to vector, C - carcass to vector
