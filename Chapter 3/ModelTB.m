function dydt = ModelTB(t, y, prevalence, K1)
dydt = zeros(10,1);

%%% Model function for wild boar TB only. Function used for analysis section
%%% of Chapter 3
...
dydt(1) = b*(Y+A)*(1-q*N) - beta_DP*y(1)*G/N - omega*beta_FP*y(1)*y(10)                  - m*y(1) - d_P*y(1); 
dydt(2) =                   beta_DP*y(1)*G/N + omega*beta_FP*y(1)*y(10) - epsilon_P*y(2) - m*y(2) - d_P*y(2);
dydt(3) =                   epsilon_P*y(2) - alpha*y(3) - m*y(3) - d_P*y(3);

%% Yearlings

dydt(4) = m*y(1) - m*y(4) - d_Y*y(4) - c*y(4) - beta_DY*y(4)*G/N - omega*beta_FY*y(4)*y(10);                  
dydt(5) = m*y(2) - m*y(5) - d_Y*y(5) - c*y(5) + beta_DY*y(4)*G/N + omega*beta_FY*y(4)*y(10) - epsilon_Y*y(5);
dydt(6) = m*y(3) - m*y(6) - d_Y*y(6) - c*y(6) + epsilon_Y*y(5) - alpha*y(6); 

%% Adults

dydt(7) = m*y(4) - d_A*y(7) - c*y(7) - beta_DA*y(7)*G/N - omega*beta_FA*y(7)*y(10);
dydt(8) = m*y(5) - d_A*y(8) - c*y(8) + beta_DA*y(7)*G/N + omega*beta_FA*y(7)*y(10) - epsilon_A*y(8);
dydt(9) = m*y(6) - d_A*y(9) - c*y(9) + epsilon_A*y(8) - alpha*y(9);      
